...
JShape::JShape()
{
  ...
  AObject* object = new CubeShape(3, 19, sf::Color::Blue);
  current.push_back(object);
  
  // POINT DE PIVOT
  object = new CubeShape(4, 19, sf::Color::Blue);
  current.push_back(object);

  object = new CubeShape(5, 19, sf::Color::Blue);
  current.push_back(object);

  object = new CubeShape(5, 18, sf::Color::Blue);
  current.push_back(object);
}
...
void JShape::draw(sf::RenderWindow& window)
{
  for (int i = 0; i < 4; i++)
  {
...
void JShape::update(sf::Keyboard input,
                    sf::Time etime,
...
void JShape::_rotateN(std::vector<std::vector<AObject*> >& map)
{
...
void JShape::_rotateE(std::vector<std::vector<AObject*> >& map)
{
  int x = current[1]->_pos_x;
  int y = current[1]->_pos_y;
...
void JShape::_rotateS(std::vector<std::vector<AObject*> >& map)
{
  int x = current[1]->_pos_x;
  int y = current[1]->_pos_y;
...
void JShape::_rotateO(std::vector<std::vector<AObject*> >& map)
{
  int x = current[1]->_pos_x;
  int y = current[1]->_pos_y;
